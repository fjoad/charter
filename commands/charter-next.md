...
Invoke the `turn-ritual` skill to:
1. Classify the next step as small/medium/major based on its complexity
2. Apply the matching ritual:
   - Small: create in-context plan, execute, verify
   - Medium: use writing-plans skill, save plan to docs/plans/, proceed with TDD
